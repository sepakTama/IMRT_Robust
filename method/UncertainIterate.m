...
for z=1:iterationNum
    ...
    % x0 is starting point (->����_�ł���ȂɎ��Ԃ��ς��Ȃ�)
        ...
        for ind = 1:max(size(Input{str}.lp))
            if Input{str}.lp(ind) > 1-(1e-3) 
               ...
               for voxel=1:Input{str}.size
                   ...
                   lborigin(fixIndex+voxel) = max(lborigin(fixIndex+voxel), ld); % �����C������B�����max�Ƃ��Ă���B
                   ...
                   sps(curPos:curPos+1) = [-1 -1]; % P���l������Ȃ�΂�����ύX
                   bcon(curConst) = -ld;
